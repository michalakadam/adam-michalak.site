...
But then I noticed something: the bottleneck wasn't speed, it was control. Control that isn't preceded by thought. The ability to focus fully and stay present. If I had it at every moment with a controller in my hands, I'd fly significantly better. If I had it at every moment of my life, I'd be able to be / see / dance more often.

I mean smelling tea while making it. Hearing someone when they're talking. Noticing the experience instead of chasing thoughts. At the root of this ideal is a desire to create quality and experience life fully.
...
Axons - "cables" between neurons - can be coated in myelin, a fatty sheath produced by cells called oligodendrocytes. The electrical signal, instead of flowing continuously through the entire axon, "jumps" between the nodes of the myelin sheath. The result: a signal up to 100x faster, significantly more reliable and precise.
...
Slow, deliberate practice at the edge of your ability works differently. The signal is clean enough for the brain to record the right pattern. And each error correction - that specific moment of struggle and repair - is the strongest trigger for myelination. The brain doesn't myelinate repetition as such. It myelinates *corrected* repetition.
...
The prefrontal cortex - the seat of conscious thinking, planning, decision-making - has very limited bandwidth. When a skill isn't myelinated, every micro-decision has to pass through it. The effect: delay (thought precedes movement), resource drain, bottleneck.

When pathways are myelinated, execution transfers to the cerebellum and basal ganglia - structures that operate outside conscious attention, faster and more reliably than the cortex. The prefrontal cortex gets freed.

But not for doing nothing. For pure observation.
...
In both cases, what's missing is the same thing: sufficient myelination of attention patterns, so that presence becomes background rather than a task. Meditation in this sense is literally myelination training for one circuit: "I notice I drifted, I return" - repeated enough times until it becomes automatic.

But there's an honest tension here worth naming. Flow and meditation produce a similar phenomenological state - a quiet prefrontal cortex, heightened presence - but they get there through different routes. In flow, presence is a side effect of myelinated skill meeting appropriate challenge. You're present because execution is automated and the task absorbs remaining attention. In meditation, presence is the direct target - you're myelinating the attention circuit itself, with no external task to absorb you.

These are two paths to a similar state, and I don't yet know how fully they converge. What I do know is that they share the same underlying mechanism - and that understanding the mechanism changed how I approach both.
